...
test("keeps financial data device-local with explicit locale metadata", async () => {
  ...
  assert.match(styles, /\.trade-table th:nth-child\(3\) \{ width:15%; \}/);
  assert.match(styles, /\.trade-table th:nth-child\(7\) \{ width:6%; \}/);
  assert.match(styles, /\.trade-table th:nth-child\(8\) \{ width:11%; \}/);
  assert.match(styles, /\.trade-table th:nth-child\(9\) \{ width:17%; \}/);
  ...
  assert.match(styles, /\.trade-table th\.trade-fund, \.trade-table td\.trade-fund \{ padding-right:10px; white-space:normal; line-height:1\.2; overflow-wrap:anywhere; \}/);
